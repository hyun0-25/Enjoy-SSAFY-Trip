...
CREATE TABLE `comment` (
  ...
  KEY `m_to_c_idx` (`user_id`),
  KEY `b_to_c_idx` (`board_id`),
  CONSTRAINT `b_to_c_id` FOREIGN KEY (`board_id`) REFERENCES `board` (`board_id`),
  CONSTRAINT `m_to_c` FOREIGN KEY (`user_id`) REFERENCES `members` (`user_id`)
