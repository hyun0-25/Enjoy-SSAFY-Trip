...
CREATE TABLE `read_count` (
  ...
  KEY `m_to_rc_userId_idx` (`user_id`),
  CONSTRAINT `b_to_rc_memberId` FOREIGN KEY (`board_id`) REFERENCES `board` (`board_id`),
  CONSTRAINT `m_to_rc_userId` FOREIGN KEY (`user_id`) REFERENCES `members` (`user_id`)
