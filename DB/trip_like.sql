...
CREATE TABLE `like` (
  ...
  KEY `b_to_l_id_idx` (`board_id`),
  CONSTRAINT `b_to_l_id` FOREIGN KEY (`board_id`) REFERENCES `board` (`board_id`),
  CONSTRAINT `m_to_l_id` FOREIGN KEY (`user_id`) REFERENCES `members` (`user_id`)
